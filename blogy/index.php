        ...
        <div class="row align-items-stretch retro-layout">
          <div class="col-md-4">
            <a href="single.php" class="h-entry mb-30 v-height gradient">
              <div
                class="featured-img"
                style="background-image: url('images/img_2_horizontal.jpg')"
              ></div>
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-sm-6 text-sm-end">
            <a href="category.php" class="read-more">View All</a>
          </div>
        </div>
        <div class="row g-3">
          <div class="col-md-9">
            <div class="row g-3">
              <div class="col-md-6">
                <div class="blog-entry">
                  ...
                  <p>
                    <a href="single.php" class="btn btn-sm btn-outline-primary"
                      >Read More</a
                    >
                  </p>
                </div>
          ...
          <div class="col-md-3">
            <ul class="list-unstyled blog-entry-sm">
              ...
              <li>
                <span class="date">Apr. 14th, 2022</span>
                <h3>
                  <a href="single.php">Meta unveils fees on metaverse sales</a>
                </h3>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde,
                  nobis ea quis inventore vel voluptas.
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="blog-entry">
              ...
              <span class="date">Apr. 14th, 2022</span>
              <h2>
                <a href="single.php">UK sees highest inflation in 30 years</a>
              </h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
              <p><a href="#" class="read-more">Continue Reading</a></p>
            </div>
